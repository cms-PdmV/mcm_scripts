...
campaigntochain = 'wmLHEGS' # 'GS' # 'wmLHEGS' #'pLHE'
...
#For pLHE
    ochain = 'chain_RunIIFall17pLHE_flowRunIIFall17pLHE2GS_flowRunIIFall17DRPremix_flowRunIIFall17MiniAODv2_flowRunIIFall17NanoAODv4'
    dchain = 'chain_RunIIFall17pLHE_flowRunIIFall17pLHE2GS_flowRunIIFall17DRPremix_flowRunIIFall17MiniAODv2_flowRunIIFall17NanoAODv4'
...
for pwg in listprep:
    ...
    while len(requests) > 0:
        if(campaigntochain=='wmLHEGS'):
            requests = mcm.get('requests', query='member_of_campaign=%s&pwg=%s&member_of_chain=*wmLHEGS_flowRunIIFall17DRPremix_*' % (campaign_name,pwg), page=page)
            page += 1
            ...
            requests = mcm.get('requests', query='member_of_campaign=%s&pwg=%s&member_of_chain=*pLHE*Premix_*' % (campaign_name,pwg), page=page)
            page += 1
