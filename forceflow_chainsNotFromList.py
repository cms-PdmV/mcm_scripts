...
chained_requests = mcm.get('chained_requests', query='member_of_campaign=%s&pwg=HIG' % (dest_chained_campaign))
...
for chained_request in chained_requests:
    ...
    if(root_id_req['status']== 'done' and dr_id_req['status']== 'done' and miniAOD_id_req['status']== 'approved' and nanoAOD_id_req['status']== 'approved'):
