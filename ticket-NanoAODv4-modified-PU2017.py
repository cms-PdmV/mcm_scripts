...
ochain = 'chain_RunIIFall17wmLHEGS_flowRunIIFall17DRPremixPU2017_flowRunIIFall17MiniAODv2_flowRunIIFall17NanoAOD'
dchain = 'chain_RunIIFall17wmLHEGS_flowRunIIFall17DRPremixPU2017_flowRunIIFall17MiniAODv2_flowRunIIFall17NanoAODv4'
...
for pwg in listprep:
    requests = mcm.get('requests', query='member_of_campaign=%s&pwg=%s&member_of_chain=*PremixPU2017*' % (campaign_name,pwg))
...
print len(requests_for_that_repeat)
